...
React.render(
  React.createElement(App, null), document.getElementById('notifications')
);
...
var Notification = React.createClass({displayName: "Notification",
  ...
  render: function(){
    ...
    return(
      React.createElement("div", {className: css, title: this.props.type, onClick: this.clickHandler}, 
        React.createElement("i", {className: _type})
      )
    );
  }
});
