...
var OslPlayer = React.createClass({displayName: "OslPlayer",
  getInitialState: function(){
    return {
  ...
  render: function(){
    return(
      React.createElement("div", {id: "osl-player"}, 
        React.createElement(Player, {track: this.state.currentTrack}), 
        React.createElement("hr", null), 
        React.createElement(PlayList, {songs: this.state.tracks, onItemClick: this.onClick})
      )
    );
  }
});
...
},{"./player.jsx":149,"./playlist.jsx":150,"react":147}],149:[function(require,module,exports){
var React = require('react');
  ...
  render: function(){
    return(
      React.createElement("div", null, 
        React.createElement("p", null, "playing : ", this.props.track.title), 
        React.createElement("audio", {controls: true}, 
          React.createElement("source", {src: this.props.track.path, type: "audio/mpeg"})
        )
      )
    );
  }
...
var PlayList = React.createClass({displayName: "PlayList",
  ...
  add_item: function(item){
    return(
      React.createElement("li", {key: item.title, onCick: this.clickHandler}, 
        item.title
      )
    );
  },
...
var React = require('react');
var OslPlayer = require('./components/osl-player.jsx');

React.render(
  React.createElement(OslPlayer, null), document.getElementById('osl-player')
);


},{"./components/osl-player.jsx":148,"react":147}]},{},[151]);
